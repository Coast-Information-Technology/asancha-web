  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.grid}>
        <div className={styles.card}><h2>Controlled access</h2><p className={styles.muted}>Every application, client, scope, key, plan, and environment remains subject to backend approval.</p></div>
        ...
        <div className={styles.card}><h2>Secure credentials</h2><p className={styles.muted}>API keys are shown once, stored securely by the backend, and tracked using safe prefixes only.</p></div>
      </div>
      <div className={styles.notice}>API Partner is not an ordinary public signup role. API keys become available only after application approval, client activation, scope assignment, and any required subscription or payment checks.</div>
    </div>
  );
}
